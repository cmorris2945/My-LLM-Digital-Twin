...
def digital_twin_etl_fresh_run(
    user_full_name: str = 'Chris Morris',
    links: list[str] = None
):
    '''Full ETL pipeline using my websites and accounts as a data source.'''
    
    # Create user
    user = get_or_create_user(user_full_name)

    # Fix the condition - should be 'is None' not 'in None'
    if links is None:
        links = [
            # GitHub Profile & Repositories
            'https://github.com/cmorris2945',
            'https://github.com/cmorris2945/Titanic-MLOps',
